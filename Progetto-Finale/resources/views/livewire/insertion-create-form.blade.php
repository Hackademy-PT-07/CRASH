            ...
            <form wire:submit.prevent="store" class="py-3">
                <div class="row text-white ">
                    <div class="mt-1 col-12 col-md-5">
                        ...
                        @error('insertion.title') <p class="small rounded my-2 errorBackground text-danger">
                            {{ $message }}
                        </p> @enderror
                    </div>
                    <div class="mt-1 col-12 col-md-4">
                        ...
                        <select name="categories[]" id="category_id" class="form-control"
                            wire:model="insertion.category_id" value=" ">
                    ...
                    <div class="mt-2 col-12 col-md-3">
                        ...
                        @error('insertion.price') <p class="small rounded my-2 errorBackground text-danger">
                            {{ $message }}
                        </p>
                        @enderror
                    </div>
